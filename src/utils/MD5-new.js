...
export function md5RotateLeft (lValue, iShiftBits) {
  return (lValue << iShiftBits) | (lValue >>> (32 - iShiftBits))
}

export function md5AddUnsigned (lX, lY) {
...
export function md5WordToHex (lValue) {
  var WordToHexValue = ''
...
export function md5Utf8Encode (string) {
